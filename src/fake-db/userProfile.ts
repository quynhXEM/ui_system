export const db = {
  users: {
    profile: {
      about: [
        { property: 'fullname', value: 'John Doe', icon: 'tabler-user' },
      ...
      contacts: [
        { property: 'phone_number', value: '(123) 456-7890', icon: 'tabler-phone-call' },
      ...
      overview: [
        { property: 'task_compiled', value: '13.5k', icon: 'tabler-check' },
        { property: 'connections', value: '897', icon: 'tabler-users' },
        { property: 'project_compiled', value: '146', icon: 'tabler-layout-grid' }
      ],
      connections: [
        {
          isFriend: true,
