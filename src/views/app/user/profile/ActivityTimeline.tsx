...
const ActivityTimeline = () => {
  ...
  return (
    <Card>
      <CardHeader
        title={dictionary.activity_timeline}
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex items-center justify-between flex-wrap gap-x-4 pbe-[7px]'>
                ...
                <Typography variant='caption'>12 {dictionary.min_ago}</Typography>
              </div>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex items-center justify-between flex-wrap gap-x-4 pbe-[7px]'>
                ...
                <Typography variant='caption'>45 {dictionary.min_ago}</Typography>
              </div>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <div className='flex items-center justify-between flex-wrap gap-x-4 pbe-[7px]'>
                ...
                <Typography variant='caption'>2 {dictionary.day_ago}</Typography>
              </div>
